...
public sealed class PaymentAllocationSeedBuilder : ISeedBuilder
{
    ...
    public ModelBuilder Seed(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PaymentAllocation>().HasData(
            ...
            new PaymentAllocation { Id = 2, PaymentId = 2, ChargeId = 3, CourseNameSnapshot = "Business Communication", SchoolNameSnapshot = "Westhaven Secondary School", ChargeGrossAmountSnapshot = 160m, ChargeNetAmountSnapshot = 140m, ChargeRemainingAmountSnapshot = 140m, Amount = 140m, CreatedAt = createdAt },
            ...
            new PaymentAllocation { Id = 4, PaymentId = 4, ChargeId = 5, CourseNameSnapshot = "Digital Media Design", SchoolNameSnapshot = "Central Heights School", ChargeGrossAmountSnapshot = 200m, ChargeNetAmountSnapshot = 180m, ChargeRemainingAmountSnapshot = 180m, Amount = 180m, CreatedAt = createdAt },
            ...
            new PaymentAllocation { Id = 7, PaymentId = 7, ChargeId = 7, CourseNameSnapshot = "Electrical Engineering Basics", SchoolNameSnapshot = "Lakeside Technical School", ChargeGrossAmountSnapshot = 240m, ChargeNetAmountSnapshot = 200m, ChargeRemainingAmountSnapshot = 200m, Amount = 200m, CreatedAt = createdAt },
