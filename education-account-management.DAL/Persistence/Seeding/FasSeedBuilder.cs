    ...
    public sealed class FasSeedBuilder : ISeedBuilder
    {
        ...
        public ModelBuilder Seed(ModelBuilder modelBuilder)
        {
            ...
            for (int i = 0; i < 25; i++)
            {
                ...
                var isApproved = status is FasApplicationStatus.Approved or FasApplicationStatus.Expired;
            ...
            {
                new() { Id = 1, FasApplicationId = 1, FasSchemeRequiredDocumentId = 1, DocumentNameSnapshot = "Recent Payslip", FileKey = "fas/applications/1/document.pdf", FileName = "fas-application-01.pdf", CreatedAt = createdAt },
                new() { Id = 2, FasApplicationId = 2, FasSchemeRequiredDocumentId = 2, DocumentNameSnapshot = "Income Statement", FileKey = "fas/applications/2/document.pdf", FileName = "fas-application-02.pdf", CreatedAt = createdAt },
                new() { Id = 3, FasApplicationId = 3, FasSchemeRequiredDocumentId = 3, DocumentNameSnapshot = "Recent Payslip", FileKey = "fas/applications/3/document.pdf", FileName = "fas-application-03.pdf", CreatedAt = createdAt },
                new() { Id = 4, FasApplicationId = 4, FasSchemeRequiredDocumentId = 4, DocumentNameSnapshot = "Income Statement", FileKey = "fas/applications/4/document.pdf", FileName = "fas-application-04.pdf", CreatedAt = createdAt },
                new() { Id = 5, FasApplicationId = 5, FasSchemeRequiredDocumentId = 5, DocumentNameSnapshot = "Recent Payslip", FileKey = "fas/applications/5/document.pdf", FileName = "fas-application-05.pdf", CreatedAt = createdAt },
                new() { Id = 6, FasApplicationId = 6, FasSchemeRequiredDocumentId = 6, DocumentNameSnapshot = "Income Statement", FileKey = "fas/applications/6/document.pdf", FileName = "fas-application-06.pdf", CreatedAt = createdAt },
                new() { Id = 7, FasApplicationId = 7, FasSchemeRequiredDocumentId = 7, DocumentNameSnapshot = "Recent Payslip", FileKey = "fas/applications/7/document.pdf", FileName = "fas-application-07.pdf", CreatedAt = createdAt },
                new() { Id = 8, FasApplicationId = 8, FasSchemeRequiredDocumentId = 8, DocumentNameSnapshot = "Income Statement", FileKey = "fas/applications/8/document.pdf", FileName = "fas-application-08.pdf", CreatedAt = createdAt },
                new() { Id = 9, FasApplicationId = 9, FasSchemeRequiredDocumentId = 9, DocumentNameSnapshot = "Recent Payslip", FileKey = "fas/applications/9/document.pdf", FileName = "fas-application-09.pdf", CreatedAt = createdAt },
                new() { Id = 10, FasApplicationId = 10, FasSchemeRequiredDocumentId = 10, DocumentNameSnapshot = "Income Statement", FileKey = "fas/applications/10/document.pdf", FileName = "fas-application-10.pdf", CreatedAt = createdAt }
            };
