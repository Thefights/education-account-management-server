...
namespace Persistence.Seeding
{
    public sealed class EnrollmentSeedBuilder : ISeedBuilder
    {
        ...
        public ModelBuilder Seed(ModelBuilder modelBuilder)
        {
            ...
            {
                new() { Id = 1, CourseId = 1, SchoolStudentId = 1, SchoolNameSnapshot = "Northview Secondary School", CourseNameSnapshot = "Quantitative Problem Solving", CourseDescriptionSnapshot = "Applied numeracy and structured problem-solving for academic pathways.", CitizenNricSnapshot = SingaporeNricUtil.Generate(1), CitizenFullNameSnapshot = "Sterling Quach", CitizenEmailSnapshot = "sterling.quach@example.com", CitizenPhoneNumberSnapshot = "+6590000001", AccountNumberSnapshot = "EDU-2026-00000000001", CreatedAt = createdAt },
