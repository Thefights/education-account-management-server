...
namespace Emails
{
    ...
    {
        public EmailTemplate BuildPasswordResetEmail(string appName, string resetUrl, DateTime expiresAt)
        {
            var safeAppName = Html(appName);
            var safeResetUrl = Html(resetUrl);
            ...
            var html = WrapHtml(
                ...
                <div style="text-align:center;margin:32px 0;">
                  <a href="{safeResetUrl}"
                     style="display:inline-block;background:#0078d4;color:#ffffff;text-decoration:none;
                            padding:14px 28px;border-radius:10px;font-weight:700;font-size:15px;">
                    Reset Password
                  </a>
                </div>

                <div style="background:#f3f6fb;border-left:4px solid #0078d4;padding:16px 18px;
                            border-radius:8px;margin:24px 0;">
                  <div style="font-size:13px;color:#4b5563;margin-bottom:4px;">This link expires at</div>
                  <div style="font-size:15px;font-weight:700;color:#111827;">{Html(expiryText)}</div>
                </div>
                ...
                <p style="margin:0 0 16px;word-break:break-all;">
                  <a href="{safeResetUrl}" style="color:#0078d4;text-decoration:underline;">{safeResetUrl}</a>
                </p>
            ...
            return new EmailTemplate("Reset your password", html, text);
        }

        public EmailTemplate BuildPasswordChangedEmail(string appName)
        {
            var safeAppName = Html(appName);
            ...
            var html = WrapHtml(
                ...
                $"""
                <div style="background:#ecfdf5;border-left:4px solid #10b981;padding:16px 18px;
                            border-radius:8px;margin:0 0 24px;">
                  <div style="font-weight:700;color:#065f46;">Password updated successfully</div>
                ...
                <p style="margin:0 0 16px;">
                  Your <strong>{safeAppName}</strong> password was changed successfully.
                </p>
            ...
            return new EmailTemplate("Your password was changed", html, text);
        }
