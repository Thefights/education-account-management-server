...
namespace Controllers
{
        ...
        : BaseController
    {
        ...
        public async Task<IActionResult> LoginWithMockSingpass(MockSingpassLoginRequestDTO request, CancellationToken cancellationToken)
        {
            var result = await _authService.LoginWithMockSingpassAsync(request, cancellationToken);
        ...
        public async Task<IActionResult> LoginWithAzureAd(AzureAdLoginRequestDTO request, CancellationToken cancellationToken)
        {
